            ...
            <div class="bg-light rounded h-100 p-4">
                ...
                <form>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" inputmode="none" id="nip">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" inputmode="none" id="gaji_pokok">
                    </div>
                    <div class="mb-3">
                        <label for="tmt_golongan" class="form-label">TMT Golongan</label>
                        <input type="date" class="form-control" id="tmt_golongan">
                    </div>
                    <div class="mb-3">
                        <label for="gaji_pokok" class="form-label">Gaji Pokok</label>
                        <input type="number" class="form-control" inputmode="none" id="gaji_pokok">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="pangkat_sekarang">
                    </div>
                    <div class="mb-3">
                        <label for="pangkat_datang" class="form-label">Pangkat Akan Datang</label>
                        <input type="date" class="form-control" id="pangkat_datang">
                    </div>
                    <div class="mb-3">
                        <label for="gaji_sekarang" class="form-label">Gaji Sekarang</label>
                        <input type="number" class="form-control" inputmode="none" id="gaji_sekarang">
                    </div>
                    <div class="mb-3">
                        <label for="gaji_datang" class="form-label">Gaji Akan Datang</label>
                        <input type="number" class="form-control" inputmode="none" id="gaji_datang">
                    </div>
                    <div class="mb-3">
